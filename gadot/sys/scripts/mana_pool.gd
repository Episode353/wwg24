...
const WATER_SCENE_PATH := "res://addons/EffectBlocks/assets/water/mana_pool.tscn"
...
func _func_godot_build_complete() -> void:
	...
	if not water_area.is_in_group("mana_pool"):
		water_area.add_to_group("mana_pool", true)
